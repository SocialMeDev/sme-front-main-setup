...
const SettingEditFilterGear = createIcon({
  displayName: 'SettingEditFilterGear',
  viewBox: '0 0 24 24',
  path: (
    <>
      <g
...
function CustomIcon({ ...rest }) {
  return <Icon as={SettingEditFilterGear} {...rest} />
}
